...
export const SignInComponent = () => {
  ...
  return (
    <div className="w-[427px] h-[520px] rounded-[40px] bg-white border border-[#E4E4E7] px-[52px] pt-[54px] pb-[29px]">
      ...
      <div className="mt-[57px] flex flex-col items-center">
        ...
        >
          <p className="text-white font-medium text-base">{t("signIn")}</p>
        </button>
        <Link
          href="/sign-up"
          className="text-[14px] text-black mt-[3px] h-[29px]"
        >
          {t("signUp")}
        </Link>
        <Link
